(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const r of l.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function a(i){if(i.ep)return;i.ep=!0;const l=s(i);fetch(i.href,l)}})();function h(){}function N(e){return e()}function H(){return Object.create(null)}function _(e){e.forEach(N)}function Z(e){return typeof e=="function"}function j(e,t){return e!=e?t==t:e!==t||e&&typeof e=="object"||typeof e=="function"}function W(e){return Object.keys(e).length===0}function p(e,t,s){e.insertBefore(t,s||null)}function u(e){e.parentNode&&e.parentNode.removeChild(e)}function w(e){return document.createElement(e)}function U(e){return document.createTextNode(e)}function $(){return U(" ")}function x(e,t,s){s==null?e.removeAttribute(t):e.getAttribute(t)!==s&&e.setAttribute(t,s)}function G(e){return Array.from(e.childNodes)}let T;function b(e){T=e}const g=[],B=[];let v=[];const E=[],D=Promise.resolve();let M=!1;function F(){M||(M=!0,D.then(I))}function L(e){v.push(e)}const k=new Set;let m=0;function I(){if(m!==0)return;const e=T;do{try{for(;m<g.length;){const t=g[m];m++,b(t),K(t.$$)}}catch(t){throw g.length=0,m=0,t}for(b(null),g.length=0,m=0;B.length;)B.pop()();for(let t=0;t<v.length;t+=1){const s=v[t];k.has(s)||(k.add(s),s())}v.length=0}while(g.length);for(;E.length;)E.pop()();M=!1,k.clear(),b(e)}function K(e){if(e.fragment!==null){e.update(),_(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(L)}}function R(e){const t=[],s=[];v.forEach(a=>e.indexOf(a)===-1?t.push(a):s.push(a)),s.forEach(a=>a()),v=t}const y=new Set;let J;function O(e,t){e&&e.i&&(y.delete(e),e.i(t))}function Q(e,t,s,a){if(e&&e.o){if(y.has(e))return;y.add(e),J.c.push(()=>{y.delete(e),a&&(s&&e.d(1),a())}),e.o(t)}else a&&a()}function X(e){e&&e.c()}function S(e,t,s,a){const{fragment:i,after_update:l}=e.$$;i&&i.m(t,s),a||L(()=>{const r=e.$$.on_mount.map(N).filter(Z);e.$$.on_destroy?e.$$.on_destroy.push(...r):_(r),e.$$.on_mount=[]}),l.forEach(L)}function A(e,t){const s=e.$$;s.fragment!==null&&(R(s.after_update),_(s.on_destroy),s.fragment&&s.fragment.d(t),s.on_destroy=s.fragment=null,s.ctx=[])}function Y(e,t){e.$$.dirty[0]===-1&&(g.push(e),F(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function z(e,t,s,a,i,l,r,f=[-1]){const c=T;b(e);const n=e.$$={fragment:null,ctx:[],props:l,update:h,not_equal:i,bound:H(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(c?c.$$.context:[])),callbacks:H(),dirty:f,skip_bound:!1,root:t.target||c.$$.root};r&&r(n.root);let o=!1;if(n.ctx=s?s(e,t.props||{},(d,P,...C)=>{const q=C.length?C[0]:P;return n.ctx&&i(n.ctx[d],n.ctx[d]=q)&&(!n.skip_bound&&n.bound[d]&&n.bound[d](q),o&&Y(e,d)),P}):[],n.update(),o=!0,_(n.before_update),n.fragment=a?a(n.ctx):!1,t.target){if(t.hydrate){const d=G(t.target);n.fragment&&n.fragment.l(d),d.forEach(u)}else n.fragment&&n.fragment.c();t.intro&&O(e.$$.fragment),S(e,t.target,t.anchor,t.customElement),I()}b(c)}class V{$destroy(){A(this,1),this.$destroy=h}$on(t,s){if(!Z(s))return h;const a=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return a.push(s),()=>{const i=a.indexOf(s);i!==-1&&a.splice(i,1)}}$set(t){this.$$set&&!W(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}function ee(e){let t;return{c(){t=w("main"),t.innerHTML=`<div class="flex flex-wrap justify-end"><div class="w-full lg:flex-1"><article class="prose p-4"><h1>Productivity begins here</h1> 
    ...
    <article class="prose ml-4"><h2>Running locally</h2> 
        <p>Paranoid about privacy? Want to contribute to the project? Use these simple commands.</p></article> 
    <div class="mockup-code mt-4 ml-4"><pre data-prefix="&gt;" class="text-warning"><code>install git</code></pre> 
        ...
        <pre data-prefix="&gt;" class="text-success"><code>Done!</code></pre></div>`,x(t,"class","p-3 bg-base-200")},m(s,a){p(s,t,a)},p:h,i:h,o:h,d(s){s&&u(t)}}}class te extends V{constructor(t){super(),z(this,t,null,ee,j,{})}}function se(e){let t,s,a,i,l,r,f,c;return a=new te({}),{c(){t=w("div"),t.innerHTML=`<div class="navbar-start"><div class="dropdown"><label tabindex="0" class="btn btn-ghost lg:hidden"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h8m-8 6h16"></path></svg></label> 
        ...
        <a class="btn btn-ghost normal-case text-xl" href="https://42willow.github.io/nocrastinate">Nocrastinate</a></div> 
    ...
    <div class="navbar-end"><label class="btn btn-circle swap swap-rotate"><input type="checkbox"/> 
      ...
      <div class="dropdown dropdown-end"><label tabindex="0" class="btn btn-ghost btn-circle avatar"><div class="w-10 rounded-full"><img src="guest.png" alt="Profile Picture"/></div></label> 
        ...
        <ul tabindex="0" class="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52"><li><a>Profile</a></li> 
          ...
          <li><a>Manage Profiles<span class="badge">Beta</span></a></li></ul></div></div>`,s=$(),X(a.$$.fragment),i=$(),l=w("footer"),l.innerHTML=`<div><img src="nocrastinate.svg" alt="Nocrastinate logo" width="200" height="200" class="mx-auto"/> 
  ...
  <ul class="menu p-4 w-80 h-full bg-base-200"><li><a>Sidebar Item 1</a></li> 
    ...
    <li><a>Sidebar Item 2</a></li></ul>`,x(t,"class","navbar bg-base-100"),x(l,"class","footer footer-center p-10 bg-primary text-primary-content"),x(f,"class","drawer-side")},m(n,o){p(n,t,o),p(n,s,o),S(a,n,o),p(n,i,o),p(n,l,o),p(n,r,o),p(n,f,o),c=!0},p:h,i(n){c||(O(a.$$.fragment,n),c=!0)},o(n){Q(a.$$.fragment,n),c=!1},d(n){n&&u(t),n&&u(s),A(a,n),n&&u(i),n&&u(l),n&&u(r),n&&u(f)}}}class ne extends V{constructor(t){super(),z(this,t,null,se,j,{})}}new ne({target:document.getElementById("app")});
